...
const SnippetCard = ({snippet} : {snippet : Snippet}) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative h-full bg-[#1e1e2el]/80 backdrop-blur-sm rounded-xl border border-[#313244]/50 hover:border-[#313244] transition-all duration-300 overflow-hidden">
      <div className="p-6">
        {/* header */}
